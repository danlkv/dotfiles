...
if [[ "$1" == "-h" || "$1" == "--help" || -z "$1" ]]; then
    echo "Usage: CITY=<CityName> [-h | --help] $0 [script_name or script_name.sh] [...args to script_name.sh]"
    echo
    echo "Description:"
...
script_name="${1%.sh}"
shift # Remove the first argument, other args will be passed to the script
